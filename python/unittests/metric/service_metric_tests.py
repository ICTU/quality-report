...
class ServiceAvailabilityTestsMixin(object):  
    ...
    def setUp(self):  # pylint: disable=invalid-name
        ...
        project = domain.Project(nagios=FakeNagios())
        self._metric = self.metric_class(subject=FakeSubject(), project=project)
...
class ServiceResponseTimesTestsMixin(object):
    ...
    def setUp(self):  # pylint: disable=invalid-name
        ...
        project = domain.Project(javamelody=self.__javamelody)
        self._metric = self.metric_class(subject=FakeSubject(), project=project)
