...
class ARTStatementCoverageJacocoTest(unittest.TestCase):
    ...
    def setUp(self):  # pylint: disable=invalid-name
        ...
        self.__subject = FakeSubject(
            metric_source_ids={self.__jacoco: 'http://jacoco'}, version='1.1')
        self.__project = domain.Project(metric_sources={metric_source.CoverageReport:
                                                        self.__jacoco})
        self.__metric = metric.ARTStatementCoverage(subject=self.__subject,
    ...
    def test_can_be_measured(self):
        ...
        self.assertTrue(metric.ARTStatementCoverage.can_be_measured(
    ...
    def test_cant_be_measured_without_jacoco(self):
        ...
        self.assertFalse(metric.ARTStatementCoverage.can_be_measured(self.__subject,
                                                            project))
    ...
    def test_cant_be_measured_without_jacoco_id(self):
        ...
        self.assertFalse(metric.ARTStatementCoverage.can_be_measured(subject,
                                                            self.__project))
...
class ARTStatementCoverageNCoverTest(unittest.TestCase):
    ...
    def test_can_be_measured(self):
        ''' Test that the metric can be measured if the project has NCover and
            the product has an NCover id. '''
        self.assertTrue(metric.ARTStatementCoverage.can_be_measured(self.__subject,
                                                                    self.__project))
...
class ARTBranchCoverageJacocoTest(unittest.TestCase):
    ...
    def setUp(self):  # pylint: disable=invalid-name
        ...
        self.__project = domain.Project(metric_sources={metric_source.CoverageReport:
                                                        self.__jacoco})
        self.__metric = metric.ARTBranchCoverage(subject=self.__subject,
                                                 project=self.__project)
    ...
    def test_can_be_measured(self):
        ''' Test that the metric can be measured if the project has Jacoco and
            the product has a Jacoco id. '''
        self.assertTrue(metric.ARTBranchCoverage.can_be_measured(
            self.__subject, self.__project))

    def test_cant_be_measured_without_jacoco(self):
        ''' Test that the metric can not be measured without Jacoco. '''
        project = domain.Project()
        self.assertFalse(metric.ARTBranchCoverage.can_be_measured(self.__subject,
                                                                  project))
    ...
    def test_cant_be_measured_without_jacoco_id(self):
        ''' Test that the metric can not be measured if the product has no
            Jacoco id. '''
        subject = FakeSubject(version='1.1')
        self.assertFalse(metric.ARTBranchCoverage.can_be_measured(subject,
                                                                  self.__project))
...
class ARTBranchCoverageNCoverTest(unittest.TestCase):
    ...
    def test_can_be_measured(self):
        ''' Test that the metric can be measured if the project has NCover and
            the product has an NCover id. '''
        self.assertTrue(metric.ARTBranchCoverage.can_be_measured(self.__subject,
                                                                 self.__project))
...
class FailingRegressionTestsTest(unittest.TestCase):
    ...
    def test_url(self):
        ...
        self.assertEqual({'Test report (1/1)': 'jenkins_job'},
                         self.__metric.url())
    ...
    def test_url_multiple_jobs(self):
        ...
        failing_tests = metric.FailingRegressionTests(subject=subject,
                                                      project=self.__project)
        self.assertEqual({'Test report (1/2)': 'a',
                          'Test report (2/2)': 'b'},
                         failing_tests.url())
