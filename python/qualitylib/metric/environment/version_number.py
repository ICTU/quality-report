...
class SonarQualityProfileVersion(HigherIsBetterMetric):
    ...
    def url(self):
        return self._create_url_dict(self._metric_source.metric_source_name, self._metric_source.quality_profiles_url())
...
class SonarPluginVersion(HigherIsBetterMetric):
    ...
    def url(self):
        return self._create_url_dict(self._metric_source.metric_source_name, self._metric_source.plugins_url())
