...
class FailingRegressionTestsTest(unittest.TestCase):
    ...
    def test_report(self):
        ...
        self.assertEqual(
            "Van de 18 FakeSubject regressietesten zijn er 4 niet geslaagd (waarvan 4 gefaald en 0 overgeslagen).",
    ...
    def test_report_with_skipped_tests(self):
        ...
        self.assertEqual(
            "Van de 20 FakeSubject regressietesten zijn er 6 niet geslaagd (waarvan 4 gefaald en 2 overgeslagen).",
            self.__metric.report())
