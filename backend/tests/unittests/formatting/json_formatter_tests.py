...
class MetaDataFormatterTest(unittest.TestCase):
    ...
    def test_process(self):
        ...
        self.assertEqual('{"domain_objects": [{"included": true, "name": "Document", "id": "Document", '
                         ...
                         '"Track technical debt", "Track the last security test date", '
                         ...
                         '"optional_requirements": ["Time since last security test", "Track actions", '
                         ...
                         '"Track ready user stories", "Track risks", "Track technical debt", '
                         '"Track the last security test date", '
                         '"Track whether user stories have security and performance risks", '
                         ...
                         '["Scrum team", "Track absence"]}], "requirements": [{"included": true, "name": '
                         '"Automated regression test coverage", "id": "ARTCoverage", "metrics": '
                         '["Automatic regression test branch coverage", "Automatic regression test statement coverage",'
                         ' "Coveragerapportageleeftijd"]}, {"included": false, "name": "Automated regression tests", '
                         '"id": "ART", "metrics": ["Hoeveelheid falende regressietesten", "Regressietestleeftijd"]}], '
