...
class MetaDataFormatterTest(unittest.TestCase):
    ...
    def test_process(self):
        ...
        self.assertEqual('{"domain_objects": [{"included": true, "name": "Document", "id": "Document", '
                         ...
                         '"Track open findings", "Track open security bug reports", '
                         '"Track open static security analysis bug reports", "Track quality gate", '
                         '"Track technical debt", "Unit and/or integration tests", '
                         '"User stories and logical test cases"]}, {"included": true, '
                         '"name": "Project", "id": "Project", "default_requirements": [], '
                         '"optional_requirements": ["Track actions", "Track manual logical test cases", '
                         '"Track open bug reports", "Track open findings", "Track open security bug reports", '
                         '"Track open static security analysis bug reports", "Track ready user stories", '
                         '"Track risks", "Track technical debt", "Track whether user stories have security and '
                         'performance risks", "Trusted Product Maintainability, version 6.1"]}, '
                         '{"included": true, "name": "Team", "id": "Team", "default_requirements": ["Track spirit"], '
