...
from hqlib.metric_source import SonarCoverageReport, Sonar


class SonarCoverageReportTest(unittest.TestCase):
    """ Unit tests for the SonarQube coverage report class. """
    ...
    def test_statement_coverage(self, unittest_line_coverage):
        ...
        coverage_report = SonarCoverageReport("http://sonar/")
